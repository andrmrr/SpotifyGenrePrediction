...
HOW MANY models were tested and the most accurate model ended up being WHICH ONE
...
5. Feature Selection - based on **correlation** and *8feature importance** gained from **Mutual Information** and **Random Forest**
